...
zSetDecodedEntriesStreamingDF.withColumn("encodedCustomer",from_json("customer",customerSchema)).select(col('customer.*')).createOrReplaceTempView("CustomerRecords")
